...
class Quotes{
    ...
    var quotes = [
        ...
        ("A successful man is one who can lay a firm foundation with the bricks others have thrown at him.","---David Brinkleya ---"),
        ...
        ("When I dare to be powerful, to use my strength in the service of my vision, then it becomes less and less important whether I am afraid.","---Audre Lorde---"), ("Whenever you find yourself on the side of the majority, it is time to pause and reflect.","---Mark Twain---"),
        ("The successful warrior is the average man, with laser-like focus.","---Bruce Lee---"),
        ("There is no traffic jam along the extra mile.","---Roger Staubach---"),
        ("Develop success from failures. Discouragement and failure are two of the surest stepping stones to success.","---Dale Carnegie---"),
        ("If you don't design your own life plan, chances are you'll fall into someone else's plan. And guess what they have planned for you? Not much.","---Jim Rohn---"), ("If you genuinely want something, don't wait for it--teach yourself to be impatient.","---Gurbaksh Chahal---"),
        ...
        ("I don't want to get to the end of my life and find that I lived just the length of it. I want to have lived the width of it as well.","---Diane Ackerman---"), ("You must expect great things of yourself before you can do them.","---Michael Jordan---"),
    ...
    func randomQuote() -> (String, String) {
